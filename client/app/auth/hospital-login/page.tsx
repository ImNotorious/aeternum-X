...
export default function HospitalLoginPage() {
  ...
  const { signInAsHospital, signInWithGoogle, loading: authLoading } = useAuth()
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      handleRedirectToAdminDashboard()
    } catch (error: any) {
          ...
          <Card className="border-primary/20 bg-gradient-to-b from-primary/5 to-transparent backdrop-blur-sm shadow-xl">
            ...
            <CardContent>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                >
                  <GlowingButton type="submit" className="w-full" disabled={isLoading || authLoading}>
